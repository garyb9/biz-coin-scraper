...
class BizCoinScraper():
    ...
    def __init__(self, board: str='biz', filters: list=[]):
        ...
        self.coingecko_coins_symbols = []
        self.coingecko_coins_price_chart = {}
        print('Done.')
    
    def toJSON(self):
        pass
    
    def clean_html(self, rawText: str):
    ...
    def update_coingecko(self):
        ...
        self.coingecko_coins_symbols = [x['symbol'] for x in self.coingecko_coins_list]
        print("Done.")
        return self.coingecko_coins_list
    
    def get_all_text(self):
        allText = [
            self.clean_html(rawText=x.comment) for x in self.posts
        ]
        wordHist = {}
        1==1